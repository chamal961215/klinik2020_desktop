            ...
            <form action="querry/patient_edit.php" method="post">
                ...
                <div class="form-row mb-2" style="padding-top: 5px; margin-left: -15px; margin-right: -18px ">
                    <div class="col-md-12">
                      ...
                      <div class="input-group col-md-10">
                        ...
                        <div class="col-md-3"><input type="text" class="form-control" id="middlename" name="middlename" placeholder="ex: xxxx"  value = <?php echo $mname;?>></div>
                ...
                <div class="form-row pb-3">
                    <div class="col-md-3">
                        <label for="bloodtype">Blood Type</label>
                            <select class="browser-default custom-select rounded-left" id="bloodtype" name="bloodtype">
                              <option value=<?php echo $blood;?>  selected="selected"><?php echo $blood;?></option>
                    ...
                    <div class="form-row mb-2">
                        ...
                        name="edit-patient-details" style="margin-top:31px; margin-left:0px ;"> Confirm and Submit</button>
                    </div>
                   
                </div>
                </div>
                <div class="float-right" style="margin-top: -365px; margin-right: 30px">
                  <img src="img/user.png" class="col-md-12 mb-4 rounded-circle" alt="user image" style="width: 300px; height: 275px;">
                  <br>
