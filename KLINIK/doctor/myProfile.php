...
if ($result->num_rows > 0) {
    ...
    echo "<p><center><b><h3>".$title."</b>".' '."<b>". $name."</b></center></p></h3><br>";    
        $img='<img src="img/download.jpg"  alt="user image" style="width: 200px; height: 200px;"><br>';
...
<a href="editdoctorinfo.php?id='.$_SESSION['id'].'" type="submit" name ="edit" id="edit" class="btn btn-secondary btn-icon-split" >
