...
<!--?php include('includes/doctor_edit.php');?>-->
  ...
  <div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Edit Assistant</h1>
    </div>
    ...
    <div class="tab-content" id="nav-tabContent" style="background-color: #ffffff; margin-left: -10px; margin-left: -12px; margin-top: -0.5px;" >
        <div class="tab-pane fade show active border border-top-1" id="nav-addDoctor" role="tabpanel" aria-labelledby="nav-addDoctor-tab" style="  background-color: #ffffff; padding: 25px; padding-top: 5px; padding-bottom: 20px; z-index: 0;">
            <!-- Add doctor form -->
            <form action="includes/assistant_edit.php" method="post">
                <div class="col-md-8">
                ...
                <div class="form-row mb-2">
                    <div class="col-md-5">
                         <label for="slmc_no">Staff No.</label>
                         <input type="text" class="form-control" id="staff_id" placeholder="#####" 
                ...
                <div class="form-row">
                    ...
                    <div class="form-row mb-2">
                        <button type="submit"  class="btn btn-primary col-md-10" name="edit-assistant-details" style="margin-top:31px; margin-left:0px ;"> Confirmed and Submit</button>
                    </div>
