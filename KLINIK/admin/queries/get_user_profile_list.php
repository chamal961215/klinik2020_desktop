<?php
    ...
    $query = "SELECT id,title,name,email,enrollment_key,user_enroll_status FROM user WHERE is_deleted IS Null AND user_type!='Admin' ORDER BY name LIMIT $start_from,$num_per_page";
